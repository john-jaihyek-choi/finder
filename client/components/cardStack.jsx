...
export default class CardStack extends React.Component {
  constructor(props) {
    super(props);
    this.state = { restaurants: this.props.cardStack, details: null, index: this.props.index, canRewind: false, showDetails: false };
      ...
      <div className='mx-auto vw-100 vh-100 d-flex flex-column align-items-center justify-content-center'>
        <div className='w-100 h-100 my-3'>
          <div className='h-100 mt-4 d-flex align-items-start justify-content-around'>
            <div className='d-flex align-items-center text-secondary' onClick={() => this.props.setView('search')}><i className='fas fa-arrow-left fa-2x gray'></i></div>
            <div className='d-flex align-items-center text-pink'><i className='fas fa-utensils fa-2x'></i></div>
            <div className='d-flex align-items-center text-secondary' onClick={this.toLikedRestaurant}><i className='fas fa-heart fa-2x hover gray'></i></div>
          </div>
        </div>
