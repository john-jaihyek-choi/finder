...
export default class CurrentSearch extends React.Component {
  ...
  handleClick(event) {
    ...
    if (event.target.id === "cardstack" && this.state.currentQuery)
      return this.props.setView("cardstack");
        ...
        <div className="column w-90 my-5 display-flex">
          ...
          <div className="my-5">
            <div className="justify-content-left">
              <h4 className="text-pink justify-content-left ml-3">
                Current Query
              </h4>
            </div>
            <div className="justify-content-center">
              <h4 className="query w-95 px-1 py-2 justify-content-center">
          ...
          <div className="wrapper justify-content-center mt-5">
            ...
            <input
              className="search text-secondary shadow w-100 px-1 py-2 justify-content-left"
              placeholder="Search"
          ...
          <div className="d-flex justify-content-center mt-2">
            <button
              type="text"
              form="userSignUp"
              className="w-25 mt-2 btn submit font-weight-bold"
              id="submit"
              onClick={this.handleClick}
            >
              SUBMIT
